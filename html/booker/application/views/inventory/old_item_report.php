        ...
        <div class="row top10">
            <div class="col-md-12">
                <form action="<?php echo base_url() ?>inventory/itemReport">
                    ...
                    <input type="text" class="form-control dtpicker" placeholder="Date To" name="date_to"
    ...
    <script>
        $(document).ready(function () {
            ...
            var oTable = $('#itable').dataTable({
                ...
                "sAjaxSource": "<?php echo base_url() ?>inventory/getOldItemReport",
                "fnServerParams": function (aoData) {
                    aoData.push({
                        "name": "date_from",
                        "value": "<?php echo $this->input->get('date_from')?>"
                    }, {"name": "date_to", "value": "<?php echo $this->input->get('date_to')?>"});
                },
                "sServerMethod": "GET",
                "aoColumns": [
