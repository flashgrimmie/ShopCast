...
.hide-calendar .ui-datepicker-calendar
{
	...
	visibility:hidden!important
            ...
            <div class="container">
              ...
              <div class="row top10"> 
			  		<div class="col-md-12">
						<form action="<?php echo base_url()?>system_setup/customers" style="float: left;width: 296px;" method="post">
							<!--<input type="text" class="form-control dtpicker" placeholder="Date From" name="date_from" value=""/>-->
							<input type="text" class="form-control dtpicker" placeholder="Date From" name="date_from" value="<?php echo date("M Y",strtotime($date_filter));?>"/>
...
$(document).ready(function(){
  ...
  var oTable = $('#membersTable').dataTable({
    ...
    "fnRowCallback": function( nRow, aData, iDisplayIndex ) {
            ...
            var stat='<a title="Monthly Statement" class="btn btn-xs btn-default" href="javascript:popup(\'<?php echo base_url() ?>documents/customer_statement/' + aData['0'] + '/<?php echo $date_filter;?>\')"><i class="fa fa-file"></i></a>';
            var payment='<a class="btn btn-xs btn-default" href="<?php echo base_url() ?>system_setup/customer_payments/' + aData['0'] + '/<?php echo $date_filter;?>"><i class="fa fa-dollar"></i></a>';
