<?php $this->load->view('templates/header'); ?>
    ...
    <div class="container">
        <div class="row top10">
            <div class="col-md-12">
                <a href="<?php echo base_url() ?>retail/create_ri" class="btn btn-primary pull-right mb clearform">
                    <i class="icon-plus-sign"></i> New Returns Note
                </a>
            </div>
        </div>
        <!-- ==================== TABLE ROW ==================== -->
    ...
    <script>
        $(document).ready(function () {
            var oTable = $('#membersTable').dataTable({
                ...
                "sAjaxSource": "<?php echo base_url() ?>retail/getReturnsNotes/",
                "sServerMethod": "POST",
                "aaSorting": [[0, 'desc']],
                "aoColumns": [
                ...
                "fnRowCallback": function (nRow, aData, iDisplayIndex) {
                    ...
                    var view_file = '<a class="btn btn-xs btn-default" href="javascript:popup(\'<?php echo base_url() ?>documents/returns_notes/' + aData['5'] + '\')"><i class="fa fa-file"></i></a>';
