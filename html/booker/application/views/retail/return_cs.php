            ...
            <div class="col-md-12">
                <div class="widget">
                    <div class="widget-head">
                        <div class="pull-left">C.S Items</div>
                            ...
                            <?php foreach ($i_items as $item_details) { ?>
                                <tr class="text-center" id="item_<?php echo $item_details->iitem_id ?>">
                                    ...
                                    <td><a class="btn btn-xs btn-default"
                                           id="returnitem_<?php echo $item_details->iitem_id ?>" data-toggle="modal"
                                           href="#modalReturn" role="button">
                ...
                <div class="padd top10">
                    <div class="control-group width60 pull-right">
                        <label class="control-label"
                               for="total">Discount:&nbsp;<?php echo isset($invoice_details) ? $invoice_details->discount : '0' ?>
                            %</label>
                    </div>
                    <div class="clearfix"></div>
                    <div class="control-group width60 pull-right">
                        <label class="control-label" for="total">Total:&nbsp;<span
                                id="total"><?php echo format_price(isset($invoice_details) ? $invoice_details->total : '0') ?></span></label>
                    </div>
                    <div class="clearfix"></div>
                    <div class="submit form-group clearfix top10">
                        <!-- <a class="btn btn-default pull-right" href="javascript:popup('<?php echo base_url() ?>documents/cash_sale/<?php echo $this->uri->segment(3) ?>')"><i class="fa fa-print"></i>&nbsp;Print</a>-->
                        <a class="btn btn-default pull-right"
                           href="<?php echo base_url() ?>retail/create_cncs/<?php echo $this->uri->segment(3) ?>"><i
                                class="fa fa-print"></i>&nbsp;Cash Return</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="control-group">
                        <label class="control-label" for="stock_num">Stock Code:&nbsp;</label><span
                            id="stock_num"></span>
                        <input type="hidden" id="iitem_id"/>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="description">Description:&nbsp;</label><span
                            id="description"></span>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="quantity">QTY to return:&nbsp;<input id="quantity"
                                                                                               style="display:inline-block"
                                                                                               class="form-control inputsmall"/></label>
                    </div>
                    <div class="control-group">
                        <p class="error"></p>
                    </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#returnitems').click(function () {
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url() ?>retail/return_csitem",
            ...
            $('body').on('click', '[id*="undoreturn_"]', function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url() ?>retail/undoreturn_csitem",
                    data: {id: id}
                }).done(function (msg) {
