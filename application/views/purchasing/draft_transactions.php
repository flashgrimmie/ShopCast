<?php $this->load->view('templates/header'); ?>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12">
                <a href="<?php echo base_url() ?>purchasing/void_transactions" class="btn btn-default pull-right top10">Void
                    Transactions</a>
            </div>
        </div>
        <div class="row">
    ...
    <script>
        $(document).ready(function () {
            ...
            var oTable = $('#membersTable').dataTable({
                ...
                "sAjaxSource": "<?php echo base_url() ?>purchasing/getDraftTransactions",
                "sServerMethod": "GET",
                "aaSorting": [[1, 'desc']],
                "aoColumns": [
                ...
                "fnRowCallback": function (nRow, aData, iDisplayIndex) {
                    var doc;
					if(aData[3]=="Purchase Return") {
						var proceed_file='<a class="btn btn-xs btn-default" href="<?php echo base_url() ?>purchasing/return_pi/' + aData['4']+'"><i class="fa fa-edit"></i></a>';
						$('td:eq(4)', nRow).html(proceed_file);
					}else if (aData[3] == "Purchase Order") {
                        doc = "po";
                    } else if (aData[3] == "Purchase Invoice") {
                        doc = "pi";
                    }
                    if(aData[3] !="Purchase Return")
					{
						var proceed_file='<a class="btn btn-xs btn-default" href="<?php echo base_url() ?>purchasing/create_'+doc+'/' + aData['4']+'"><i class="fa fa-edit"></i></a>';
						var discard_file='<a class="btn btn-xs btn-danger void_transaction" href="#modalVoidTransaction" data-toggle="modal" data-href="<?php echo base_url() ?>retail/discard_'+doc+'/' + aData['4']+'">Void</a>';
						$('td:eq(4)', nRow).html(proceed_file+discard_file);
					}
                    return nRow;
                },
            });
