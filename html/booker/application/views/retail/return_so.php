    ...
    <div class="col-md-12">
      <div class="widget">
        <div class="widget-head">
          <div class="pull-left">S.O Items</div>
    ...
    <div class="col-md-12">
      <div class="padd top10">
        ...
        <div class="submit form-group clearfix top10">
          <a class="btn btn-default pull-right" href="javascript:popup('<?php echo base_url() ?>documents/sales_order/<?php echo $this->uri->segment(3)?>')"><i class="fa fa-print"></i>&nbsp;Print</a>
        </div>
      </div>
    </div>
  </div>
...
$(document).ready(function(){
  ...
  $('#returnitems').click(function(){
    $.ajax({
      type: "POST",
      url: "<?php echo base_url() ?>retail/return_soitem",
  ...
  $('body').on('click','[id*="undoreturn_"]',function(){
    ...
    $.ajax({
      type: "POST",
      url: "<?php echo base_url() ?>retail/undoreturn_soitem",
      data: {id:id}
    }).done(function( msg ) {
